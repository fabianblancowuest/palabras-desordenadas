		...
		<div className="min-h-screen bg-linear-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
			<div className="w-full max-w-md mx-auto">
				...
				<div className="text-center mb-8">
					...
					<h2 className="text-3xl">DALE LUCERO, JUGÁ </h2>
				...
				<Card className="backdrop-blur-sm bg-white/80 border-0 shadow-xl">
					<CardContent className="p-8">
						...
						<div className="mb-8">
							<h2
								className="text-center text-sm font-medium text-gray-500 mb-4 uppercase tracking-wide flex items-center justify-center gap-2"
								style={{
									minHeight: 30,
								}}
							>
				...
				<footer className="text-center mt-6">
					...
					>
						<p>Desafíate con palabras desordenadas!</p>
						<p>{words.join(", ")}</p>
					</div>
				</footer>
			</div>
